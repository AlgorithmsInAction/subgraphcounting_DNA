...
usage() {
  ...
  echo "Writes one summary row with only the total time for processing all applied updates." >&2
}
...
output_path="${2:-$(default_output_path "$input_path" ".total_time_stats.csv")}"
